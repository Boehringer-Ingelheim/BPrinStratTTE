...
- For recent reviews of applications to clinical trials see @Lipkovich2022 and @Bornkamp2021. So far, experience with respect to clinical trial settings with time-to-event endpoints appears to be particularly limited.
- Principal stratum membership of subjects is not known with certainty and needs to be estimated. For this package, principal stratum membership is treated as a latent mixture variables, following a proposal by @Imbens1997.
