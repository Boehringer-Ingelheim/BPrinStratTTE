...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_m_exp_nocovar");
    reader.add_event(108, 106, "end", "model_m_exp_nocovar");
    return reader;
}
#include <stan_meta_header.hpp>
class model_m_exp_nocovar
  : public stan::model::model_base_crtp<model_m_exp_nocovar> {
private:
        int n;
        int tg;
        std::vector<int> Z;
...
typedef model_m_exp_nocovar_namespace::model_m_exp_nocovar stan_model;
#ifndef USING_R
