...
#include "stanExports_m_bprinstrat_exp_covar.h"

RCPP_MODULE(stan_fit4m_bprinstrat_exp_covar_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_m_bprinstrat_exp_covar")
