...
namespace model_m_bprinstrat_exp_nocovar_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_m_bprinstrat_exp_nocovar");
    reader.add_event(108, 106, "end", "model_m_bprinstrat_exp_nocovar");
    return reader;
}
#include <stan_meta_header.hpp>
class model_m_bprinstrat_exp_nocovar
  : public stan::model::model_base_crtp<model_m_bprinstrat_exp_nocovar> {
private:
        int n;
        int tg;
        std::vector<int> Z;
        ...
        vector_d t_grid;
public:
    model_m_bprinstrat_exp_nocovar(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_m_bprinstrat_exp_nocovar_namespace::model_m_bprinstrat_exp_nocovar";
        ...
        try {
            ...
            validate_non_negative_index("prior_piT", "2", 2);
            context__.validate_dims("data initialization", "prior_piT", "double", context__.to_vec(2));
            prior_piT = std::vector<double>(2, double(0));
            vals_r__ = context__.vals_r("prior_piT");
            pos__ = 0;
            size_t prior_piT_k_0_max__ = 2;
            for (size_t k_0__ = 0; k_0__ < prior_piT_k_0_max__; ++k_0__) {
                prior_piT[k_0__] = vals_r__[pos__++];
            }
            size_t prior_piT_i_0_max__ = 2;
            for (size_t i_0__ = 0; i_0__ < prior_piT_i_0_max__; ++i_0__) {
                check_greater_or_equal(function__, "prior_piT[i_0__]", prior_piT[i_0__], 0);
            }
    ...
    ~model_m_bprinstrat_exp_nocovar() { }
    void transform_inits(const stan::io::var_context& context__,
        ...
        std::vector<int> vals_i__;
        current_statement_begin__ = 27;
        if (!(context__.contains_r("pi_T")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable pi_T missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("pi_T");
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "pi_T", "double", context__.to_vec());
        double pi_T(0);
        pi_T = vals_r__[pos__++];
        try {
            writer__.scalar_lub_unconstrain(0, 1, pi_T);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable pi_T: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 28;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                pi_T = in__.scalar_lub_constrain(0, 1, lp__);
            else
                pi_T = in__.scalar_lub_constrain(0, 1);
            current_statement_begin__ = 28;
            ...
            lp_accum__.add(beta_log<propto__>(pi_T, get_base1(prior_piT, 1, "prior_piT", 1), get_base1(prior_piT, 2, "prior_piT", 1)));
            ...
            for (int i = 1; i <= n; ++i) {
                ...
                if (as_bool(logical_eq(get_base1(Z, i, "Z", 1), 0))) {
                    ...
                    stan::model::assign(prob, 
                                ...
                                log_mix(pi_T, ((get_base1(EVENT, i, "EVENT", 1) * stan::math::log(lambda_0T)) - (lambda_0T * get_base1(TIME, i, "TIME", 1))), ((get_base1(EVENT, i, "EVENT", 1) * stan::math::log(lambda_0N)) - (lambda_0N * get_base1(TIME, i, "TIME", 1)))), 
                    ...
                    stan::model::assign(prob, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                (log1m(pi_T) + ((get_base1(EVENT, i, "EVENT", 1) * stan::math::log(lambda_1N)) - (lambda_1N * get_base1(TIME, i, "TIME", 1)))), 
                                "assigning variable prob");
                } else if (as_bool((primitive_value(logical_eq(get_base1(Z, i, "Z", 1), 1)) && primitive_value(logical_eq(get_base1(S, i, "S", 1), 1))))) {
                    current_statement_begin__ = 58;
                    stan::model::assign(prob, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                (stan::math::log(pi_T) + ((get_base1(EVENT, i, "EVENT", 1) * stan::math::log(lambda_1T)) - (lambda_1T * get_base1(TIME, i, "TIME", 1)))), 
                                "assigning variable prob");
                }
            }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_m_bprinstrat_exp_nocovar_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        // read-transform, write parameters
        double pi_T = in__.scalar_lub_constrain(0, 1);
        vars__.push_back(pi_T);
    ...
    std::string model_name() const {
        return "model_m_bprinstrat_exp_nocovar";
    }
...
typedef model_m_bprinstrat_exp_nocovar_namespace::model_m_bprinstrat_exp_nocovar stan_model;
#ifndef USING_R
