...
namespace model_m_bprinstrat_exp_covar_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_m_bprinstrat_exp_covar");
    reader.add_event(116, 114, "end", "model_m_bprinstrat_exp_covar");
    return reader;
}
#include <stan_meta_header.hpp>
class model_m_bprinstrat_exp_covar
  : public stan::model::model_base_crtp<model_m_bprinstrat_exp_covar> {
private:
        int n;
        int nt;
        int p;
        ...
        vector_d t_grid;
public:
    model_m_bprinstrat_exp_covar(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_m_bprinstrat_exp_covar_namespace::model_m_bprinstrat_exp_covar";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_m_bprinstrat_exp_covar_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_m_bprinstrat_exp_covar";
    }
...
typedef model_m_bprinstrat_exp_covar_namespace::model_m_bprinstrat_exp_covar stan_model;
#ifndef USING_R
